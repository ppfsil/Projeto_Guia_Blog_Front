...
function Perfil() {
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      <img className='w-full h-72 object-cover border-b-8 border-white' src='https://i.pinimg.com/564x/2c/a7/95/2ca7951a83fe1f563623dae5eae4b56d.jpg' alt="Capa do Perfil" />
